...
extends BaseZombie {
    ...
    public void onDamage(SEntity sEntity, Entity damager, EntityDamageByEntityEvent e, AtomicDouble damage) {
        ...
        SUtil.delay(() -> WatcherPutrid.lambda$onDamage$0((Entity)en, v), 1L);
    }
        ...
        if (SUtil.random(0, 20) == 1) {
            ...
            killed.getNearbyEntities(5.0, 5.0, 5.0).forEach(entity -> {
                if (entity instanceof Player) {
                    ...
                    p.damage(1.0E-5);
                    User.getUser(p.getUniqueId()).damage(p.getMaxHealth() * 10.0 / 100.0, EntityDamageEvent.DamageCause.ENTITY_ATTACK, (Entity)killed);
                }
            });
        }
    }
